...
const (
	...
	// SupportBundleTimeoutDefault and SupportBundleTimeoutDefaultStr these two value should be changed together.
	SupportBundleTimeoutDefault    = 50
	SupportBundleTimeoutDefaultStr = "50"
)
