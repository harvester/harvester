...
const (
	...
	LabelMaintainForceShutdownStrategy      = prefix + "/maintain-force-shutdown-strategy"
	LabelNodeNameKey                        = "kubevirt.io/nodeName"
	AnnotationMaintainForceShutdownNodeName = prefix + "/maintain-force-shutdown-node-name"
