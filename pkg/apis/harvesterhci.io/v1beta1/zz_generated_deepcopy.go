...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CPUModelCapabilities) DeepCopyInto(out *CPUModelCapabilities) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CPUModelCapabilities.
func (in *CPUModelCapabilities) DeepCopy() *CPUModelCapabilities {
	if in == nil {
		return nil
	}
	out := new(CPUModelCapabilities)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineCPUModelStatus) DeepCopyInto(out *VirtualMachineCPUModelStatus) {
	*out = *in
	if in.GlobalModels != nil {
		in, out := &in.GlobalModels, &out.GlobalModels
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.Models != nil {
		in, out := &in.Models, &out.Models
		*out = make(map[string]CPUModelCapabilities, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
