...
func Test_calculateAllocation(t *testing.T) {
	...
	assert.Equal(nodeDeviceAvailability["intel.com/X540_ETHERNET_CONTROLLER_VIRTUAL_FUNCTION"], *resource.NewQuantity(30, resource.DecimalSI), "expect to find 12 X540_ETHERNET_CONTROLLER_VIRTUAL_FUNCTION VF's")
}
