...
// cleanupErrorIntent removes drain intent annotations ('harvesterhci.io/drain-requested'
// and 'harvesterhci.io/drain-forced') after a maintenance mode failure is recorded.
// It verifies that the live node is still in an Error condition before clearing annotations,
// preventing continuous reconcile retries while ensuring terminal failures remain visible.
