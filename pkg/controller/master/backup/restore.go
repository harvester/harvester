...
func (h *RestoreHandler) initStatus(restore *harvesterv1.VirtualMachineRestore) error {
	...
	harvesterv1.BackupConditionProgressing.True(restoreCpy)
	harvesterv1.BackupConditionProgressing.Reason(restoreCpy, "")
	harvesterv1.BackupConditionProgressing.Message(restoreCpy, "Initializing VirtualMachineRestore")
	harvesterv1.BackupConditionReady.False(restoreCpy)
	harvesterv1.BackupConditionReady.Reason(restoreCpy, "")
	harvesterv1.BackupConditionReady.Message(restoreCpy, "Initializing VirtualMachineRestore")
...
func (h *RestoreHandler) updateStatus(
	...
	if !isVolumesReady {
		...
		harvesterv1.BackupConditionProgressing.True(restoreCpy)
		harvesterv1.BackupConditionProgressing.Reason(restoreCpy, "")
		harvesterv1.BackupConditionProgressing.Message(restoreCpy, "Creating new PVCs")
		harvesterv1.BackupConditionReady.False(restoreCpy)
		harvesterv1.BackupConditionReady.Reason(restoreCpy, "")
		harvesterv1.BackupConditionReady.Message(restoreCpy, "Waiting for new PVCs")
	...
	if !vm.Status.Ready {
		...
		harvesterv1.BackupConditionProgressing.False(restoreCpy)
		harvesterv1.BackupConditionProgressing.Reason(restoreCpy, "")
		harvesterv1.BackupConditionProgressing.Message(restoreCpy, message)
		harvesterv1.BackupConditionReady.False(restoreCpy)
		harvesterv1.BackupConditionReady.Reason(restoreCpy, "")
		harvesterv1.BackupConditionReady.Message(restoreCpy, message)
		if !reflect.DeepEqual(vmRestore, restoreCpy) {
			if _, err := h.restores.Update(restoreCpy); err != nil {
				return err
			}
	...
	harvesterv1.BackupConditionProgressing.False(restoreCpy)
	harvesterv1.BackupConditionProgressing.Reason(restoreCpy, "")
	harvesterv1.BackupConditionProgressing.Message(restoreCpy, "Operation complete")
	harvesterv1.BackupConditionReady.True(restoreCpy)
	harvesterv1.BackupConditionReady.Reason(restoreCpy, "")
	harvesterv1.BackupConditionReady.Message(restoreCpy, "Operation complete")
	if _, err := h.restores.Update(restoreCpy); err != nil {
		return err
	}
	return nil
...
func (h *RestoreHandler) updateStatusError(restore *harvesterv1.VirtualMachineRestore, err error, createEvent bool) error {
	restoreCpy := restore.DeepCopy()
	harvesterv1.BackupConditionProgressing.False(restoreCpy)
	harvesterv1.BackupConditionProgressing.Reason(restoreCpy, "Error")
	harvesterv1.BackupConditionProgressing.Message(restoreCpy, err.Error())
	harvesterv1.BackupConditionReady.False(restoreCpy)
	harvesterv1.BackupConditionReady.Reason(restoreCpy, "Error")
	harvesterv1.BackupConditionReady.Message(restoreCpy, err.Error())
