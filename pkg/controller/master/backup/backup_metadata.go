...
func (h *MetadataHandler) syncVMBackup(target *settings.BackupTarget) error {
	...
	for _, fileName := range fileNames {
		...
		if err := h.createVMBackupIfNotExist(*backupMetadata); err != nil {
			return err
		}
	}
	return nil
...
func (h *MetadataHandler) createVMBackupIfNotExist(backupMetadata VirtualMachineBackupMetadata) error {
