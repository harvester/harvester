...
func (v *upgradeValidator) checkResources(version *v1beta1.Version) error {
	...
	if cluster.Status.Phase != string(clusterv1beta1.ClusterPhaseProvisioned) {
...
func (v *upgradeValidator) checkMachines() error {
	...
	for _, machine := range machines {
		if machine.Status.GetTypedPhase() != clusterv1beta1.MachinePhaseRunning {
...
func (v *upgradeValidator) Delete(_ *types.Request, oldObj runtime.Object) error {
	...
	if cluster.Status.Phase == string(clusterv1beta1.ClusterPhaseProvisioning) {
