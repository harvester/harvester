...
func Test_virtualMachineValidator_storagenetworknad(t *testing.T) {
	tests := []struct {
		...
		{
			name: "vm1 refers to a storagenetwork nad which has annotation, not allowed",
			vm: &kubevirtv1.VirtualMachine{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "new-vm",
					Namespace: "default",
		...
		{
			name: "vm2 refers to a storagenetwork nad which starts with storagenetwork name preix, not allowed",
			vm: &kubevirtv1.VirtualMachine{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "vm2",
					Namespace: "default",
