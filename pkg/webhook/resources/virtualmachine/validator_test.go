...
func Test_virtualMachineValidator_duplicateMacAddress_withDanglingInterfaces(t *testing.T) {
	tests := []struct {
		name        string
		vm          *kubevirtv1.VirtualMachine
		expectError bool
		...
		{
			name: "remove the dangling interface 2 of vm1",
			vm: &kubevirtv1.VirtualMachine{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "vm1",
					Namespace: "default",
		...
		{
			name: "remove the dangling interfance 2, but vm1 current netwok and interface do not match",
			vm: &kubevirtv1.VirtualMachine{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "vm1",
					Namespace: "default",
						...
						Spec: kubevirtv1.VirtualMachineInstanceSpec{
							...
							Domain: kubevirtv1.DomainSpec{
								Devices: kubevirtv1.Devices{
									Interfaces: []kubevirtv1.Interface{
										{
											Name:       "nic-2", // interface and network mismatch
											MacAddress: "00:00:00:00:00:02",
										},
									},
								},
		...
		{
			name: "change the dangling interface to correct network",
			vm: &kubevirtv1.VirtualMachine{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "vm1",
					Namespace: "default",
						...
						Spec: kubevirtv1.VirtualMachineInstanceSpec{
							Networks: []kubevirtv1.Network{
								...
								},
								{
									...
									NetworkSource: kubevirtv1.NetworkSource{
										Multus: &kubevirtv1.MultusNetwork{
											NetworkName: "default/vlan-2", // from dangling to normal
										},
									},
								},
							},
		...
		{
			name: "change the dangling interface to correct network but a duplicated MAC",
			vm: &kubevirtv1.VirtualMachine{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "vm1",
					Namespace: "default",
							...
							Domain: kubevirtv1.DomainSpec{
								Devices: kubevirtv1.Devices{
									Interfaces: []kubevirtv1.Interface{
										...
										{
											Name:       "nic-2",
											MacAddress: "00:00:00:00:00:12", // conflict with vm2
										},
									},
								},
							},
		...
		{
			name: "change the dangling interface to correct network but vm1 itself has duplicated MAC",
			vm: &kubevirtv1.VirtualMachine{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "vm1",
					Namespace: "default",
						...
						Spec: kubevirtv1.VirtualMachineInstanceSpec{
							Networks: []kubevirtv1.Network{
								...
								},
								{
									...
									NetworkSource: kubevirtv1.NetworkSource{
										Multus: &kubevirtv1.MultusNetwork{
											NetworkName: "default/vlan-1", // from dangling to normal
										},
									},
								},
							},
							Domain: kubevirtv1.DomainSpec{
								Devices: kubevirtv1.Devices{
									Interfaces: []kubevirtv1.Interface{
										...
										{
											Name:       "nic-2",
											MacAddress: "00:00:00:00:00:01", // self conflicts
										},
									},
								},
							},
		...
		{
			name: "change the dangling interface to correct network but vm1 itself has duplicated MACs and both MACs are new",
			vm: &kubevirtv1.VirtualMachine{
				ObjectMeta: metav1.ObjectMeta{
					Name:      "vm1",
					Namespace: "default",
							...
							Domain: kubevirtv1.DomainSpec{
								Devices: kubevirtv1.Devices{
									Interfaces: []kubevirtv1.Interface{
										{
											Name:       "nic-1",
											MacAddress: "00:00:00:00:00:51", // both MAC are new
										},
										{
											Name:       "nic-2",
											MacAddress: "00:00:00:00:00:51", // self conflicts
										},
									},
								},
							},
	...
	label4 := make(map[string]string)
	label4[keyClusterNetwork] = "cluster-4"
					...
					Spec: kubevirtv1.VirtualMachineInstanceSpec{
						Networks: []kubevirtv1.Network{
							...
							},
							{
								...
								NetworkSource: kubevirtv1.NetworkSource{
									Multus: &kubevirtv1.MultusNetwork{
										NetworkName: "default/vlan-88", // dangling
									},
								},
							},
						},
