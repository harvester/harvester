...
func checkSnapshotLimit(snapshotLimit v1beta1.SnapshotLimit) error {
	if snapshotLimit.NamespaceTotalSnapshotSizeQuota < 0 {
		return werror.NewInvalidError("must be greater than or equal to 0", "spec.snapshotLimit.namespaceTotalSnapshotSizeQuota")
	}
