...
var usersResource = schema.GroupVersionResource{Group: "harvesterhci.io", Version: "v1beta1", Resource: "users"}

var usersKind = schema.GroupVersionKind{Group: "harvesterhci.io", Version: "v1beta1", Kind: "User"}
...
func (c *FakeUsers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.User, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(usersResource, name), &v1beta1.User{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeUsers) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.UserList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(usersResource, usersKind, opts), &v1beta1.UserList{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeUsers) Create(ctx context.Context, user *v1beta1.User, opts v1.CreateOptions) (result *v1beta1.User, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(usersResource, user), &v1beta1.User{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.User), err
...
func (c *FakeUsers) Update(ctx context.Context, user *v1beta1.User, opts v1.UpdateOptions) (result *v1beta1.User, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(usersResource, user), &v1beta1.User{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.User), err
...
func (c *FakeUsers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(usersResource, name), &v1beta1.User{})
	return err
}
...
func (c *FakeUsers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.User, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(usersResource, name, pt, data, subresources...), &v1beta1.User{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.User), err
