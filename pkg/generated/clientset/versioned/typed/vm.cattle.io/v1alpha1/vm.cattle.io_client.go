...
import (
	...
	"github.com/rancher/vm/pkg/generated/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*VmV1alpha1Client, error) {
	...
	return &VmV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new VmV1alpha1Client for the given config and
...
func New(c rest.Interface) *VmV1alpha1Client {
	return &VmV1alpha1Client{c}
}
