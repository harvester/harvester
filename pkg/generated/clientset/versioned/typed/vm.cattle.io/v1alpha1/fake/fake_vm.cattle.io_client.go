...
import (
	v1alpha1 "github.com/rancher/harvester/pkg/generated/clientset/versioned/typed/vm.cattle.io/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeVmV1alpha1 struct {
	*testing.Fake
}

func (c *FakeVmV1alpha1) Images(namespace string) v1alpha1.ImageInterface {
