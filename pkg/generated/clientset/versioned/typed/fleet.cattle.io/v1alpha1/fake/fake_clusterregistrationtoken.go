...
var clusterregistrationtokensResource = v1alpha1.SchemeGroupVersion.WithResource("clusterregistrationtokens")

var clusterregistrationtokensKind = v1alpha1.SchemeGroupVersion.WithKind("ClusterRegistrationToken")
...
func (c *FakeClusterRegistrationTokens) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(clusterregistrationtokensResource, c.ns, name, opts), &v1alpha1.ClusterRegistrationToken{})
