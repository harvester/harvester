...
var gitreposResource = v1alpha1.SchemeGroupVersion.WithResource("gitrepos")

var gitreposKind = v1alpha1.SchemeGroupVersion.WithKind("GitRepo")
...
func (c *FakeGitRepos) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(gitreposResource, c.ns, name, opts), &v1alpha1.GitRepo{})
