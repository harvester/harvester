...
var gitreporestrictionsResource = v1alpha1.SchemeGroupVersion.WithResource("gitreporestrictions")

var gitreporestrictionsKind = v1alpha1.SchemeGroupVersion.WithKind("GitRepoRestriction")
...
func (c *FakeGitRepoRestrictions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(gitreporestrictionsResource, c.ns, name, opts), &v1alpha1.GitRepoRestriction{})
