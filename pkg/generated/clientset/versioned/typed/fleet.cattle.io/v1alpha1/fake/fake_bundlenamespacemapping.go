...
var bundlenamespacemappingsResource = v1alpha1.SchemeGroupVersion.WithResource("bundlenamespacemappings")

var bundlenamespacemappingsKind = v1alpha1.SchemeGroupVersion.WithKind("BundleNamespaceMapping")
...
func (c *FakeBundleNamespaceMappings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(bundlenamespacemappingsResource, c.ns, name, opts), &v1alpha1.BundleNamespaceMapping{})
