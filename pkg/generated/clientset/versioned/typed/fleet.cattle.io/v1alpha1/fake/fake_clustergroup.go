...
var clustergroupsResource = v1alpha1.SchemeGroupVersion.WithResource("clustergroups")

var clustergroupsKind = v1alpha1.SchemeGroupVersion.WithKind("ClusterGroup")
...
func (c *FakeClusterGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(clustergroupsResource, c.ns, name, opts), &v1alpha1.ClusterGroup{})
