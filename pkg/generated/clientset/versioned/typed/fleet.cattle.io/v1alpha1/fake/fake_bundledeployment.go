...
var bundledeploymentsResource = v1alpha1.SchemeGroupVersion.WithResource("bundledeployments")

var bundledeploymentsKind = v1alpha1.SchemeGroupVersion.WithKind("BundleDeployment")
...
func (c *FakeBundleDeployments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(bundledeploymentsResource, c.ns, name, opts), &v1alpha1.BundleDeployment{})
