...
type SettingInterface interface {
	...
	UpdateStatus(ctx context.Context, setting *v1alpha1.Setting, opts v1.UpdateOptions) (*v1alpha1.Setting, error)
...
func newSettings(c *HarvesterV1alpha1Client) *settings {
	return &settings{
		client: c.RESTClient(),
	}
}
...
func (c *settings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Setting, err error) {
...
func (c *settings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SettingList, err error) {
...
func (c *settings) Create(ctx context.Context, setting *v1alpha1.Setting, opts v1.CreateOptions) (result *v1alpha1.Setting, err error) {
	result = &v1alpha1.Setting{}
	err = c.client.Post().
		Resource("settings").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *settings) Update(ctx context.Context, setting *v1alpha1.Setting, opts v1.UpdateOptions) (result *v1alpha1.Setting, err error) {
	result = &v1alpha1.Setting{}
	err = c.client.Put().
		Resource("settings").
		Name(setting.Name).
...
func (c *settings) UpdateStatus(ctx context.Context, setting *v1alpha1.Setting, opts v1.UpdateOptions) (result *v1alpha1.Setting, err error) {
	result = &v1alpha1.Setting{}
	err = c.client.Put().
		Resource("settings").
		Name(setting.Name).
...
func (c *settings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Setting, err error) {
	result = &v1alpha1.Setting{}
