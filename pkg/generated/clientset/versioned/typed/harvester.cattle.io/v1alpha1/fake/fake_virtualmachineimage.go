...
var virtualmachineimagesResource = schema.GroupVersionResource{Group: "harvester.cattle.io", Version: "v1alpha1", Resource: "virtualmachineimages"}

var virtualmachineimagesKind = schema.GroupVersionKind{Group: "harvester.cattle.io", Version: "v1alpha1", Kind: "VirtualMachineImage"}
...
func (c *FakeVirtualMachineImages) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VirtualMachineImage, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(virtualmachineimagesResource, c.ns, name, pt, data, subresources...), &v1alpha1.VirtualMachineImage{})
