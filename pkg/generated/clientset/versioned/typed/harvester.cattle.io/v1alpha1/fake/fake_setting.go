...
func (c *FakeSettings) UpdateStatus(ctx context.Context, setting *v1alpha1.Setting, opts v1.UpdateOptions) (*v1alpha1.Setting, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(settingsResource, "status", setting), &v1alpha1.Setting{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Setting), err
