...
type VirtualMachineTemplateVersionInterface interface {
	...
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.VirtualMachineTemplateVersion, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.VirtualMachineTemplateVersionList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VirtualMachineTemplateVersion, err error)
...
func newVirtualMachineTemplateVersions(c *HarvesterV1alpha1Client, namespace string) *virtualMachineTemplateVersions {
...
func (c *virtualMachineTemplateVersions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VirtualMachineTemplateVersion, err error) {
...
func (c *virtualMachineTemplateVersions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VirtualMachineTemplateVersionList, err error) {
...
func (c *virtualMachineTemplateVersions) Create(ctx context.Context, virtualMachineTemplateVersion *v1alpha1.VirtualMachineTemplateVersion, opts v1.CreateOptions) (result *v1alpha1.VirtualMachineTemplateVersion, err error) {
	result = &v1alpha1.VirtualMachineTemplateVersion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("virtualmachinetemplateversions").
...
func (c *virtualMachineTemplateVersions) UpdateStatus(ctx context.Context, virtualMachineTemplateVersion *v1alpha1.VirtualMachineTemplateVersion, opts v1.UpdateOptions) (result *v1alpha1.VirtualMachineTemplateVersion, err error) {
	result = &v1alpha1.VirtualMachineTemplateVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualmachinetemplateversions").
...
func (c *virtualMachineTemplateVersions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VirtualMachineTemplateVersion, err error) {
	result = &v1alpha1.VirtualMachineTemplateVersion{}
