...
type UserHandler func(string, *v1beta1.User) (*v1beta1.User, error)
...
type UserClient interface {
	Create(*v1beta1.User) (*v1beta1.User, error)
	Update(*v1beta1.User) (*v1beta1.User, error)

	Delete(name string, options *metav1.DeleteOptions) error
	Get(name string, options metav1.GetOptions) (*v1beta1.User, error)
	List(opts metav1.ListOptions) (*v1beta1.UserList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.User, err error)
}

type UserCache interface {
	Get(name string) (*v1beta1.User, error)
	List(selector labels.Selector) ([]*v1beta1.User, error)

	AddIndexer(indexName string, indexer UserIndexer)
	GetByIndex(indexName, key string) ([]*v1beta1.User, error)
}

type UserIndexer func(obj *v1beta1.User) ([]string, error)
...
func FromUserHandlerToHandler(sync UserHandler) generic.Handler {
	return func(key string, obj runtime.Object) (ret runtime.Object, err error) {
		...
		if obj == nil {
			...
			v, err = sync(key, obj.(*v1beta1.User))
		}
		if v == nil {
			return nil, err
		}
...
func (c *userController) Updater() generic.Updater {
	return func(obj runtime.Object) (runtime.Object, error) {
		newObj, err := c.Update(obj.(*v1beta1.User))
		if newObj == nil {
			return nil, err
		}
		return newObj, err
...
func UpdateUserDeepCopyOnChange(client UserClient, obj *v1beta1.User, handler func(obj *v1beta1.User) (*v1beta1.User, error)) (*v1beta1.User, error) {
	if obj == nil {
		return obj, nil
	}
...
func (c *userController) Create(obj *v1beta1.User) (*v1beta1.User, error) {
	result := &v1beta1.User{}
	return result, c.client.Create(context.TODO(), "", obj, result, metav1.CreateOptions{})
}

func (c *userController) Update(obj *v1beta1.User) (*v1beta1.User, error) {
	result := &v1beta1.User{}
...
func (c *userController) Get(name string, options metav1.GetOptions) (*v1beta1.User, error) {
	result := &v1beta1.User{}
	return result, c.client.Get(context.TODO(), "", name, result, options)
}

func (c *userController) List(opts metav1.ListOptions) (*v1beta1.UserList, error) {
...
func (c *userController) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (*v1beta1.User, error) {
	result := &v1beta1.User{}
...
func (c *userCache) Get(name string) (*v1beta1.User, error) {
...
func (c *userCache) List(selector labels.Selector) (ret []*v1beta1.User, err error) {
...
func (c *userCache) AddIndexer(indexName string, indexer UserIndexer) {
	utilruntime.Must(c.indexer.AddIndexers(map[string]cache.IndexFunc{
		indexName: func(obj interface{}) (strings []string, e error) {
			return indexer(obj.(*v1beta1.User))
		},
	}))
}

func (c *userCache) GetByIndex(indexName, key string) (result []*v1beta1.User, err error) {
	objs, err := c.indexer.ByIndex(indexName, key)
	if err != nil {
		return nil, err
	}
	result = make([]*v1beta1.User, 0, len(objs))
	for _, obj := range objs {
		result = append(result, obj.(*v1beta1.User))
	}
	return result, nil
}
