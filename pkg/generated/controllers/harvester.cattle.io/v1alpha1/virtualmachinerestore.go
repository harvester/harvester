...
type VirtualMachineRestoreHandler func(string, *v1alpha1.VirtualMachineRestore) (*v1alpha1.VirtualMachineRestore, error)
...
type VirtualMachineRestoreClient interface {
	...
	Get(namespace, name string, options metav1.GetOptions) (*v1alpha1.VirtualMachineRestore, error)
	List(namespace string, opts metav1.ListOptions) (*v1alpha1.VirtualMachineRestoreList, error)
	Watch(namespace string, opts metav1.ListOptions) (watch.Interface, error)
	Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.VirtualMachineRestore, err error)
}

type VirtualMachineRestoreCache interface {
	Get(namespace, name string) (*v1alpha1.VirtualMachineRestore, error)
	List(namespace string, selector labels.Selector) ([]*v1alpha1.VirtualMachineRestore, error)

	AddIndexer(indexName string, indexer VirtualMachineRestoreIndexer)
	GetByIndex(indexName, key string) ([]*v1alpha1.VirtualMachineRestore, error)
}

type VirtualMachineRestoreIndexer func(obj *v1alpha1.VirtualMachineRestore) ([]string, error)
...
func FromVirtualMachineRestoreHandlerToHandler(sync VirtualMachineRestoreHandler) generic.Handler {
	return func(key string, obj runtime.Object) (ret runtime.Object, err error) {
		var v *v1alpha1.VirtualMachineRestore
		if obj == nil {
			v, err = sync(key, nil)
		} else {
			v, err = sync(key, obj.(*v1alpha1.VirtualMachineRestore))
		}
		if v == nil {
			return nil, err
		}
...
func (c *virtualMachineRestoreController) Updater() generic.Updater {
	return func(obj runtime.Object) (runtime.Object, error) {
		newObj, err := c.Update(obj.(*v1alpha1.VirtualMachineRestore))
		if newObj == nil {
			return nil, err
		}
		return newObj, err
...
func UpdateVirtualMachineRestoreDeepCopyOnChange(client VirtualMachineRestoreClient, obj *v1alpha1.VirtualMachineRestore, handler func(obj *v1alpha1.VirtualMachineRestore) (*v1alpha1.VirtualMachineRestore, error)) (*v1alpha1.VirtualMachineRestore, error) {
	if obj == nil {
		return obj, nil
	}
...
func (c *virtualMachineRestoreController) Create(obj *v1alpha1.VirtualMachineRestore) (*v1alpha1.VirtualMachineRestore, error) {
	result := &v1alpha1.VirtualMachineRestore{}
	return result, c.client.Create(context.TODO(), obj.Namespace, obj, result, metav1.CreateOptions{})
}

func (c *virtualMachineRestoreController) Update(obj *v1alpha1.VirtualMachineRestore) (*v1alpha1.VirtualMachineRestore, error) {
	result := &v1alpha1.VirtualMachineRestore{}
...
func (c *virtualMachineRestoreController) Get(namespace, name string, options metav1.GetOptions) (*v1alpha1.VirtualMachineRestore, error) {
	result := &v1alpha1.VirtualMachineRestore{}
	return result, c.client.Get(context.TODO(), namespace, name, result, options)
}

func (c *virtualMachineRestoreController) List(namespace string, opts metav1.ListOptions) (*v1alpha1.VirtualMachineRestoreList, error) {
...
func (c *virtualMachineRestoreController) Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (*v1alpha1.VirtualMachineRestore, error) {
	result := &v1alpha1.VirtualMachineRestore{}
...
func (c *virtualMachineRestoreCache) Get(namespace, name string) (*v1alpha1.VirtualMachineRestore, error) {
	...
	return obj.(*v1alpha1.VirtualMachineRestore), nil
}

func (c *virtualMachineRestoreCache) List(namespace string, selector labels.Selector) (ret []*v1alpha1.VirtualMachineRestore, err error) {

	err = cache.ListAllByNamespace(c.indexer, namespace, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.VirtualMachineRestore))
	})
...
func (c *virtualMachineRestoreCache) AddIndexer(indexName string, indexer VirtualMachineRestoreIndexer) {
	utilruntime.Must(c.indexer.AddIndexers(map[string]cache.IndexFunc{
		indexName: func(obj interface{}) (strings []string, e error) {
			return indexer(obj.(*v1alpha1.VirtualMachineRestore))
		},
	}))
}

func (c *virtualMachineRestoreCache) GetByIndex(indexName, key string) (result []*v1alpha1.VirtualMachineRestore, err error) {
	objs, err := c.indexer.ByIndex(indexName, key)
	if err != nil {
		return nil, err
	}
	result = make([]*v1alpha1.VirtualMachineRestore, 0, len(objs))
	for _, obj := range objs {
		result = append(result, obj.(*v1alpha1.VirtualMachineRestore))
	}
	return result, nil
}
