...
type UpgradeHandler func(string, *v1alpha1.Upgrade) (*v1alpha1.Upgrade, error)
...
type UpgradeClient interface {
	Create(*v1alpha1.Upgrade) (*v1alpha1.Upgrade, error)
	Update(*v1alpha1.Upgrade) (*v1alpha1.Upgrade, error)
	UpdateStatus(*v1alpha1.Upgrade) (*v1alpha1.Upgrade, error)
	Delete(namespace, name string, options *metav1.DeleteOptions) error
	Get(namespace, name string, options metav1.GetOptions) (*v1alpha1.Upgrade, error)
	List(namespace string, opts metav1.ListOptions) (*v1alpha1.UpgradeList, error)
	Watch(namespace string, opts metav1.ListOptions) (watch.Interface, error)
	Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Upgrade, err error)
}

type UpgradeCache interface {
	Get(namespace, name string) (*v1alpha1.Upgrade, error)
	List(namespace string, selector labels.Selector) ([]*v1alpha1.Upgrade, error)

	AddIndexer(indexName string, indexer UpgradeIndexer)
	GetByIndex(indexName, key string) ([]*v1alpha1.Upgrade, error)
}

type UpgradeIndexer func(obj *v1alpha1.Upgrade) ([]string, error)
...
func FromUpgradeHandlerToHandler(sync UpgradeHandler) generic.Handler {
	return func(key string, obj runtime.Object) (ret runtime.Object, err error) {
		var v *v1alpha1.Upgrade
		if obj == nil {
			v, err = sync(key, nil)
		} else {
			v, err = sync(key, obj.(*v1alpha1.Upgrade))
		}
		if v == nil {
			return nil, err
		}
...
func (c *upgradeController) Updater() generic.Updater {
	return func(obj runtime.Object) (runtime.Object, error) {
		newObj, err := c.Update(obj.(*v1alpha1.Upgrade))
		if newObj == nil {
			return nil, err
		}
		return newObj, err
...
func UpdateUpgradeDeepCopyOnChange(client UpgradeClient, obj *v1alpha1.Upgrade, handler func(obj *v1alpha1.Upgrade) (*v1alpha1.Upgrade, error)) (*v1alpha1.Upgrade, error) {
	if obj == nil {
		return obj, nil
	}
...
func (c *upgradeController) Create(obj *v1alpha1.Upgrade) (*v1alpha1.Upgrade, error) {
	result := &v1alpha1.Upgrade{}
	return result, c.client.Create(context.TODO(), obj.Namespace, obj, result, metav1.CreateOptions{})
}

func (c *upgradeController) Update(obj *v1alpha1.Upgrade) (*v1alpha1.Upgrade, error) {
	result := &v1alpha1.Upgrade{}
	return result, c.client.Update(context.TODO(), obj.Namespace, obj, result, metav1.UpdateOptions{})
}

func (c *upgradeController) UpdateStatus(obj *v1alpha1.Upgrade) (*v1alpha1.Upgrade, error) {
	result := &v1alpha1.Upgrade{}
...
func (c *upgradeController) Get(namespace, name string, options metav1.GetOptions) (*v1alpha1.Upgrade, error) {
	result := &v1alpha1.Upgrade{}
	return result, c.client.Get(context.TODO(), namespace, name, result, options)
}

func (c *upgradeController) List(namespace string, opts metav1.ListOptions) (*v1alpha1.UpgradeList, error) {
	result := &v1alpha1.UpgradeList{}
...
func (c *upgradeController) Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (*v1alpha1.Upgrade, error) {
	result := &v1alpha1.Upgrade{}
...
func (c *upgradeCache) Get(namespace, name string) (*v1alpha1.Upgrade, error) {
	...
	return obj.(*v1alpha1.Upgrade), nil
}

func (c *upgradeCache) List(namespace string, selector labels.Selector) (ret []*v1alpha1.Upgrade, err error) {

	err = cache.ListAllByNamespace(c.indexer, namespace, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.Upgrade))
	})
...
func (c *upgradeCache) AddIndexer(indexName string, indexer UpgradeIndexer) {
	utilruntime.Must(c.indexer.AddIndexers(map[string]cache.IndexFunc{
		indexName: func(obj interface{}) (strings []string, e error) {
			return indexer(obj.(*v1alpha1.Upgrade))
		},
	}))
}

func (c *upgradeCache) GetByIndex(indexName, key string) (result []*v1alpha1.Upgrade, err error) {
	objs, err := c.indexer.ByIndex(indexName, key)
	if err != nil {
		return nil, err
	}
	result = make([]*v1alpha1.Upgrade, 0, len(objs))
	for _, obj := range objs {
		result = append(result, obj.(*v1alpha1.Upgrade))
	}
	return result, nil
}

type UpgradeStatusHandler func(obj *v1alpha1.Upgrade, status v1alpha1.UpgradeStatus) (v1alpha1.UpgradeStatus, error)

type UpgradeGeneratingHandler func(obj *v1alpha1.Upgrade, status v1alpha1.UpgradeStatus) ([]runtime.Object, v1alpha1.UpgradeStatus, error)
...
func (a *upgradeStatusHandler) sync(key string, obj *v1alpha1.Upgrade) (*v1alpha1.Upgrade, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *upgradeGeneratingHandler) Remove(key string, obj *v1alpha1.Upgrade) (*v1alpha1.Upgrade, error) {
	if obj != nil {
		return obj, nil
	}

	obj = &v1alpha1.Upgrade{}
...
func (a *upgradeGeneratingHandler) Handle(obj *v1alpha1.Upgrade, status v1alpha1.UpgradeStatus) (v1alpha1.UpgradeStatus, error) {
