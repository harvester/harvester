...
type VolumeSnapshotClassClient interface {
	Create(*v1.VolumeSnapshotClass) (*v1.VolumeSnapshotClass, error)
	Update(*v1.VolumeSnapshotClass) (*v1.VolumeSnapshotClass, error)

	Delete(name string, options *metav1.DeleteOptions) error
	Get(name string, options metav1.GetOptions) (*v1.VolumeSnapshotClass, error)
	List(opts metav1.ListOptions) (*v1.VolumeSnapshotClassList, error)
	Watch(opts metav1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.VolumeSnapshotClass, err error)
}

type VolumeSnapshotClassCache interface {
	Get(name string) (*v1.VolumeSnapshotClass, error)
	List(selector labels.Selector) ([]*v1.VolumeSnapshotClass, error)

	AddIndexer(indexName string, indexer VolumeSnapshotClassIndexer)
	GetByIndex(indexName, key string) ([]*v1.VolumeSnapshotClass, error)
}
...
func FromVolumeSnapshotClassHandlerToHandler(sync VolumeSnapshotClassHandler) generic.Handler {
	return func(key string, obj runtime.Object) (ret runtime.Object, err error) {
		var v *v1.VolumeSnapshotClass
		if obj == nil {
			v, err = sync(key, nil)
		} else {
			v, err = sync(key, obj.(*v1.VolumeSnapshotClass))
		}
		if v == nil {
			return nil, err
		}
...
func (c *volumeSnapshotClassController) Updater() generic.Updater {
	return func(obj runtime.Object) (runtime.Object, error) {
		newObj, err := c.Update(obj.(*v1.VolumeSnapshotClass))
		if newObj == nil {
			return nil, err
		}
		return newObj, err
...
func (c *volumeSnapshotClassController) Create(obj *v1.VolumeSnapshotClass) (*v1.VolumeSnapshotClass, error) {
	result := &v1.VolumeSnapshotClass{}
	return result, c.client.Create(context.TODO(), "", obj, result, metav1.CreateOptions{})
}

func (c *volumeSnapshotClassController) Update(obj *v1.VolumeSnapshotClass) (*v1.VolumeSnapshotClass, error) {
	result := &v1.VolumeSnapshotClass{}
...
func (c *volumeSnapshotClassController) Get(name string, options metav1.GetOptions) (*v1.VolumeSnapshotClass, error) {
	result := &v1.VolumeSnapshotClass{}
	return result, c.client.Get(context.TODO(), "", name, result, options)
}

func (c *volumeSnapshotClassController) List(opts metav1.ListOptions) (*v1.VolumeSnapshotClassList, error) {
...
func (c *volumeSnapshotClassController) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (*v1.VolumeSnapshotClass, error) {
	result := &v1.VolumeSnapshotClass{}
...
func (c *volumeSnapshotClassCache) Get(name string) (*v1.VolumeSnapshotClass, error) {
...
func (c *volumeSnapshotClassCache) List(selector labels.Selector) (ret []*v1.VolumeSnapshotClass, err error) {
...
func (c *volumeSnapshotClassCache) AddIndexer(indexName string, indexer VolumeSnapshotClassIndexer) {
	utilruntime.Must(c.indexer.AddIndexers(map[string]cache.IndexFunc{
		indexName: func(obj interface{}) (strings []string, e error) {
			return indexer(obj.(*v1.VolumeSnapshotClass))
		},
	}))
}

func (c *volumeSnapshotClassCache) GetByIndex(indexName, key string) (result []*v1.VolumeSnapshotClass, err error) {
	objs, err := c.indexer.ByIndex(indexName, key)
	if err != nil {
		return nil, err
	}
	result = make([]*v1.VolumeSnapshotClass, 0, len(objs))
	for _, obj := range objs {
		result = append(result, obj.(*v1.VolumeSnapshotClass))
	}
	return result, nil
}
