...
func (a *clusterGeneratingHandler) isNewResourceVersion(obj *v1alpha4.Cluster) bool {
	if !a.opts.UniqueApplyForResourceVersion {
		return true
	}
...
// Only used if UniqueApplyForResourceVersion is set in generic.GeneratingHandlerOptions
func (a *clusterGeneratingHandler) storeResourceVersion(obj *v1alpha4.Cluster) {
	if !a.opts.UniqueApplyForResourceVersion {
		return
	}
