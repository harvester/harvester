...
func (f *backupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&longhornv1beta2.Backup{}, f.defaultInformer)
}

func (f *backupInformer) Lister() v1beta2.BackupLister {
	return v1beta2.NewBackupLister(f.Informer().GetIndexer())
}
