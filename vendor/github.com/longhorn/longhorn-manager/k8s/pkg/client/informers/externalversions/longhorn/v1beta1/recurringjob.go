	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LonghornV1beta1().RecurringJobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LonghornV1beta1().RecurringJobs(namespace).Watch(context.TODO(), options)
			},
		},
		&longhornv1beta1.RecurringJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *recurringJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&longhornv1beta1.RecurringJob{}, f.defaultInformer)
}

func (f *recurringJobInformer) Lister() v1beta1.RecurringJobLister {
	return v1beta1.NewRecurringJobLister(f.Informer().GetIndexer())
}
