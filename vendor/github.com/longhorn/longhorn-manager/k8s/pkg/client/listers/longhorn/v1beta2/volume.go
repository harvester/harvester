...
// List lists all Volumes in the indexer.
func (s *volumeLister) List(selector labels.Selector) (ret []*v1beta2.Volume, err error) {
...
// List lists all Volumes in the indexer for a given namespace.
func (s volumeNamespaceLister) List(selector labels.Selector) (ret []*v1beta2.Volume, err error) {
...
// Get retrieves the Volume from the indexer for a given namespace and name.
func (s volumeNamespaceLister) Get(name string) (*v1beta2.Volume, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta2.Resource("volume"), name)
	}
