...
// List lists all BackingImages in the indexer.
func (s *backingImageLister) List(selector labels.Selector) (ret []*v1beta1.BackingImage, err error) {
...
// List lists all BackingImages in the indexer for a given namespace.
func (s backingImageNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.BackingImage, err error) {
...
// Get retrieves the BackingImage from the indexer for a given namespace and name.
func (s backingImageNamespaceLister) Get(name string) (*v1beta1.BackingImage, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("backingimage"), name)
	}
