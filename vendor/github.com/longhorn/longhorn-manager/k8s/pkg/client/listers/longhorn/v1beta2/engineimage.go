...
// List lists all EngineImages in the indexer.
func (s *engineImageLister) List(selector labels.Selector) (ret []*v1beta2.EngineImage, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta2.EngineImage))
	})
	return ret, err
}
...
// List lists all EngineImages in the indexer for a given namespace.
func (s engineImageNamespaceLister) List(selector labels.Selector) (ret []*v1beta2.EngineImage, err error) {
...
// Get retrieves the EngineImage from the indexer for a given namespace and name.
func (s engineImageNamespaceLister) Get(name string) (*v1beta2.EngineImage, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta2.Resource("engineimage"), name)
	}
	return obj.(*v1beta2.EngineImage), nil
}
