...
type EngineInterface interface {
	Create(ctx context.Context, engine *v1alpha1.Engine, opts v1.CreateOptions) (*v1alpha1.Engine, error)
	Update(ctx context.Context, engine *v1alpha1.Engine, opts v1.UpdateOptions) (*v1alpha1.Engine, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.Engine, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.EngineList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Engine, err error)
	EngineExpansion
}
...
func (c *engines) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Engine, err error) {
...
func (c *engines) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EngineList, err error) {
...
func (c *engines) Create(ctx context.Context, engine *v1alpha1.Engine, opts v1.CreateOptions) (result *v1alpha1.Engine, err error) {
	result = &v1alpha1.Engine{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("engines").
...
func (c *engines) Update(ctx context.Context, engine *v1alpha1.Engine, opts v1.UpdateOptions) (result *v1alpha1.Engine, err error) {
	result = &v1alpha1.Engine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("engines").
...
func (c *engines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Engine, err error) {
	result = &v1alpha1.Engine{}
