...
replace (
	...
	github.com/harvester/harvester-network-controller => github.com/harvester/harvester-network-controller v1.6.0
	github.com/openshift/api => github.com/openshift/api a30da32c0ca8
	...
	github.com/rancher/rancher/pkg/apis => github.com/rancher/rancher/pkg/apis 1300d8e15a6b
	github.com/rancher/rancher/pkg/client => github.com/rancher/rancher/pkg/client 1300d8e15a6b
	...
	k8s.io/gengo => k8s.io/gengo 081d64401ab4
...
require (
	...
	github.com/harvester/node-manager v1.6.0
