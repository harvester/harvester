...
replace (
	...
	github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring => github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.52.0
	github.com/rancher/rancher/pkg/apis => github.com/rancher/rancher/pkg/apis v0.0.0-20240514215909-831650cf9a07
	github.com/rancher/rancher/pkg/client => github.com/rancher/rancher/pkg/client v0.0.0-20240514215909-831650cf9a07
	github.com/rancher/wrangler => github.com/rancher/wrangler v1.1.1-0.20240307150840-1279389d86ec
	...
	oras.land/oras-go => oras.land/oras-go v1.2.2 // for docker 20.10.x compatibilitys
...
require (
	...
	github.com/rancher/rancher v0.0.0-20240514215909-831650cf9a07
...
require (
	...
	github.com/rancher/machine v0.15.0-rancher109 // indirect
