...
- Note: These new settings are not available in the longhorn-v1 StorageClass.
- The new settings can be configured during the creation of a StorageClass and update a StorageClass.
