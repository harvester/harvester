...
**Existing VMs**
- Stopped VMs: CD-ROM volumes gain hot-plug capabilities when starting it
- Running VMs: CD-ROM volumes gain hot-plug capabilities when restarting it

**New VMs**
- CD-ROM volumes would automatically have hot-plug capabilities
