...
|-----------|---------|----------------|------------------------------------------------------------------|-------------------------------------------------------------|
| **1.8***  | 1.8.2   | Stable         | [🔗](https://github.com/harvester/harvester/releases/tag/v1.8.2) | [🔗](https://docs.harvesterhci.io/v1.8/upgrade/v1-7-x-to-v1-8-x) |
| **1.7***  | 1.7.3   | Stable         | [🔗](https://github.com/harvester/harvester/releases/tag/v1.7.3) | [🔗](https://docs.harvesterhci.io/v1.7/upgrade/v1-6-x-to-v1-7-x) |
